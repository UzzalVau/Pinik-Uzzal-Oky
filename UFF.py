...
\033[1;97m`YbodP' d8888 d8888 dP''''''''Yb 88ood8\033[1;91m88  Y8 
\033[38;5;46m———————————————————————————————————
...
try:
    ...
    proxy = requests.get('https://github.com/UzzalVau/File-cloning-2k23/blob/main/Approvals.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://github.com/UzzalVau/Gangstar-world-hacker-boyz5.0/blob/main/newf.py').text
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://github.com/UzzalVau/UZZAL-VAU-OK')
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/Uzzalvau/approve.2.txt.git').text
    if id in httpCaht:
